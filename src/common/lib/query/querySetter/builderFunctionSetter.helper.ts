import { queryBuildCases, QuoteTypeEnum, RoleEnum } from '@/common/constants/enum.constants';
import { TokenProvider } from '@/common/constants/socialAccount.constant';
import {
  CodeTypeEnum,
  defaultLanguage,
  ExamParticipateStatusEnum,
  LanguageEnum,
  QuoteStatusEnum,
  SurveyQuestionEnum,
} from '@/common/interfaces/general/general.interface';
import { parse } from '@/common/utils';
import CourseCategory from '@/sequelizeDir/models/courseCategory.model';
import { CourseMarkAsEnum, CourseStatus, CourseType } from '@/sequelizeDir/models/types/course.model.type';
import { AssignedStatus } from '@/sequelizeDir/models/types/lessonSessionApproval.model.type';
import { OrderStatus, OrderStatusType } from '@/sequelizeDir/models/types/order.model.type';
import { InvoiceStatus } from '@/sequelizeDir/models/types/quoteProduct.model.type';
...
export const caseHandlers = {
  ...
  [queryBuildCases.getAllCompanyDetails]: handleAllCompanyDetails,
  [queryBuildCases.getQuoteCompanyManagers]: handleQuoteCompanyMailList,
  [queryBuildCases.getAllChatUsers]: handleAllChatUsers,
  [queryBuildCases.getCompanyDetails]: handleCompanyDetails,
  [queryBuildCases.getUsersNotInCompanyProvided]: handleUsersNotInCompanyProvided,
  [queryBuildCases.getAllEmailTemplate]: handleAllEmailTemplate,
  [queryBuildCases.getAllSentMail]: handleAllSentMail,
  [queryBuildCases.getRoomUser]: handleRoomUser,
  [queryBuildCases.getRoomInfo]: handleRoomInfo,
  [queryBuildCases.getChatList]: handleChatList,
  [queryBuildCases.getAllCertificateTemplate]: handleAllCertificateTemplate,
  [queryBuildCases.getLatestCertificateTemplate]: handleLatest,
  [queryBuildCases.getAllCourseCategory]: handleAllCourseCategory,
  [queryBuildCases.getAllAccessPermission]: handleAllAccessPermission,
  [queryBuildCases.getAllProjectCardMembers]: handleAllProjectCardMembers,
  [queryBuildCases.getAllPaymentTerms]: handleAllPaymentTerms,
  [queryBuildCases.getAllOrder]: handleAllOrder,
  [queryBuildCases.getAllTrainerNotes]: getAllTrainerNotes,
  [queryBuildCases.getOrderDropdown]: handleOrderDropdown,
  [queryBuildCases.getAllInvoice]: handleAllInvoice,
  [queryBuildCases.getAllInvoiceAcademicProduct]: handleAllInvoiceAcademicProduct,
  [queryBuildCases.getAllTrainerInvoice]: handleTrainerInvoice,
  [queryBuildCases.getAllExpense]: handleAllExpense,
  [queryBuildCases.getAllSupplier]: handleAllSupplier,
  [queryBuildCases.getAllSupplierName]: handleAllSupplierName,
  [queryBuildCases.getAllTrainerAllInvoice]: handleTrainerAllInvoice,
  [queryBuildCases.getAllTrainer]: handleAllTrainer,
  [queryBuildCases.getAllCreditNotes]: handleAllCreditNotes,
  [queryBuildCases.getAllOrderComments]: handleAllOrderComments,
  [queryBuildCases.getAllOrderAttachments]: handleAllOrderAttachments,
  [queryBuildCases.getAllCourseResources]: handleAllCourseResources,
  [queryBuildCases.getAllSubCourseCategory]: handleAllSubCourseCategory,
  [queryBuildCases.getAllPrivateIndividualDetails]: handleAllPrivateIndividualDetails,
  [queryBuildCases.getPrivateIndividualDetails]: handlePrivateIndividualDetails,
  [queryBuildCases.getAllOptionalTrainers]: handleAllOptionalTrainers,
  [queryBuildCases.getCoursesOfBundle]: handleCoursesOfBundle,
  [queryBuildCases.getAllNotifications]: handleAllNotifications,
  [queryBuildCases.getAllCalendarEvents]: handleAllCalendarEvents,
  [queryBuildCases.getCalendarEventDetail]: handleCalendarEventDetail,
  [queryBuildCases.getAllInternalEvents]: handleAllInternalEvents,
  [queryBuildCases.getInternalEventDetail]: handleInternalEventDetail,
  [queryBuildCases.getUserSocialAccounts]: handleUserSocialAccounts,
  [queryBuildCases.getAllCourse]: handleAllCourse,
  [queryBuildCases.getAllAssignedTrainersOfCourse]: handleAllAssignedTrainersOfCourse,
  [queryBuildCases.getAllPublishedCourse]: handleAllPublishedCourse,
  [queryBuildCases.getCourseFilter]: handleCourseFilter,
  [queryBuildCases.getMembersCourse]: handleAllCourseMembers,
  [queryBuildCases.getAllCourseData]: handleAllCourseData,
  [queryBuildCases.getAllCourseManager]: handleAllCourseManager,
  [queryBuildCases.getCourseRoomResourceData]: handleRoomResourceOfCourse,
  [queryBuildCases.getAllPrivateIndividualCourse]: handleAllCoursePrivateIndividual,
  [queryBuildCases.getAllCourseManagerEnrolledCourses]: handleAllCourseManagerEnrolledCourses,
  [queryBuildCases.getCompanyManagerDashboard]: handleAllCourseManagerDashboard,
  [queryBuildCases.getCodeFilterReports]: handleCodeFilterReports,
  [queryBuildCases.getRemainCertificate]: handleCertificateRemain,
  [queryBuildCases.getCategoriesFilterReports]: handleCategoriesFilterReports,
  [queryBuildCases.getCoursePendingProposals]: handlePendingProposals,
  [queryBuildCases.getTrainerLossDashboard]: handleTrainerLossDashboard,
  [queryBuildCases.getCompanyManagerAttendee]: handleAllCourseManagerAttendees,
  [queryBuildCases.getPrivateIndividualEnrolledCourse]: handleGetPrivateIndividualEnrolledCourse,
  [queryBuildCases.getInternalCallCourse]: handleInternalCallCourse,
  [queryBuildCases.getAllCourseTemplate]: handleAllCourseTemplate,
  [queryBuildCases.getAllParticipateCourses]: handleAllParticipateCourses,
  [queryBuildCases.getAllCourseTemplateCategories]: handleAllCourseCategoryForTemplates,
  [queryBuildCases.getAllCourseTemplateForDropdown]: handleAllCourseTemplateDropdown,
  [queryBuildCases.getAcademy]: handleAcademy,
  [queryBuildCases.getTrainerTodaySession]: handleTrainerTodaySession,
  [queryBuildCases.getAssignedTrainerReport]: handleAssignedTrainingSpeRepo,
  [queryBuildCases.getProjectsByStages]: handleProjectsByStages,
  [queryBuildCases.getCourseByStages]: handleCourseByStages,
  [queryBuildCases.getProjectManagementStages]: handleProjectManagementStages,
  [queryBuildCases.getCourseManagementStages]: handleCourseManagementStages,
  [queryBuildCases.getAllProject]: handleAllProject,
  [queryBuildCases.getAllEmails]: handleAllEmails,
  [queryBuildCases.getProjectsCardDetails]: handleProjectsCardDetailsV2,
  [queryBuildCases.getCourseCardDetails]: handleCourseCardDetailsV2,
  [queryBuildCases.getAllLessonApprovals]: handleAllLessonApprovals,
  [queryBuildCases.getAllLabels]: handleAllLabels,
  [queryBuildCases.getAllQuotes]: handleAllQuotes,
  [queryBuildCases.getCodeQuotes]: handleAllCodeQuotes,
  [queryBuildCases.getAllQuoteProductLogs]: handleAllQuoteProductLogs,
  [queryBuildCases.getAllProducts]: handleAllProducts,
  [queryBuildCases.getCodeDetails]: handleCodeDetails,
  [queryBuildCases.getAllCodes]: handleCodes,
  [queryBuildCases.getAllLogs]: handleLogs,
  [queryBuildCases.getAllManagersDetails]: handleAllManagerDetails,
  [queryBuildCases.getManagerDetails]: handleManagerDetails,
  [queryBuildCases.getAttendanceSheet]: handleAttendanceSheet,
  [queryBuildCases.getAttendanceSheetOfParticipate]: handleAttendanceSheetOfParticipate,
  [queryBuildCases.getAllCourseOfTrainer]: handleGetAllCoursesOfTrainer,
  [queryBuildCases.getCourseDetails]: handleGetCourseDetails,
  [queryBuildCases.trackCourse]: handleTrackCourse,
  [queryBuildCases.getQROfExam]: handleGetCourseQROfExamDetails,
  [queryBuildCases.getQROfSurvey]: handleGetCourseQROfSurveyDetails,
  [queryBuildCases.getAllRating]: handleGetRating,
  [queryBuildCases.getAllSurveyResult]: handleGetCourseOfSurveyResult,
  [queryBuildCases.getAllCourseParticipates]: handleGetAllCourseParticipates,
  [queryBuildCases.getAllCourseBundleParticipates]: handleGetAllCourseBundleParticipates,
  [queryBuildCases.getAllCourseBundleParticipateCompanies]: handleGetAllCourseBundleParticipateCompanies,
  [queryBuildCases.getCompanyDropdown]: handleGetCompanyDropdown,
  [queryBuildCases.getFeatureDropdown]: handleGetFeatureDropdown,
  [queryBuildCases.getManagerDropdown]: handleGetManagerDropdown,
  [queryBuildCases.getAllCourseInvitationOfTrainer]: handleTrainerCourseInvitation,
  [queryBuildCases.getAllCourseBundleInvitationOfTrainer]: handleTrainerCourseBundleInvitation,
  [queryBuildCases.getAllCourseBundlesInvitationOfTrainer]: handleTrainerCourseBundlesInvitation,
  [queryBuildCases.getCompanyWiseQuotes]: handleGetCompanyWiseQuotes,
  [queryBuildCases.getAllCompanyOfCourse]: handleAllCompanyOfCourse,
  [queryBuildCases.getEnrolledCompany]: handleAllEnrolledCompany,
  [queryBuildCases.getAttendeesResult]: handleAttendeesResult,
  [queryBuildCases.getExamResult]: handleExamResult,
  [queryBuildCases.getExamResultForAllParticipate]: handleExamResult,
  [queryBuildCases.getAllFilteredTrainers]: handleAllFilteredTrainers,

  [queryBuildCases.getSelectedTrainer]: handleSelectedTrainer,
  [queryBuildCases.getAllTrainers]: handleAllTrainers,
  [queryBuildCases.getMisMatchRecords]: handleMismatchRecord,
  [queryBuildCases.getExamDetails]: handleExamDetails,
  [queryBuildCases.getAllAssignedRoomResource]: handleAllAssignedRoomResource,
  [queryBuildCases.getAllCourseUsedBundleData]: handleAllCourseUsedBundleData,
  [queryBuildCases.getCourseTrainerDetails]: handleGetCourseTrainerDetails,
  [queryBuildCases.getUserDropdownData]: handleGetUserDropDownData,
  [queryBuildCases.getCompanyCourseRequests]: handleGetCompanyCourseRequest,
  [queryBuildCases.getCourseRequests]: handleGetCourseRequests,
  [queryBuildCases.getAllCourseBundle]: handleCourseBundle,
  [queryBuildCases.getCourseRequestCourseList]: handleGetCourseRequestCourseList,
  [queryBuildCases.getAllCourseRoomBundle]: handleGetAllCourseRoomBundle,
  [queryBuildCases.getAllCourseResourceBundle]: handleGetAllCourseResourceBundle,
  [queryBuildCases.getSurveyForm]: handleSurveyForm,
  [queryBuildCases.getRoomAndResourcesAssignedToTrainers]: handleGetRoomAndResourcesAssignedToTrainers,
  [queryBuildCases.getCourseBundleRoomAndResourcesAssignedToTrainers]: handleCourseBundleGetRoomAndResourcesAssignedToTrainers,
  [queryBuildCases.getCardActivities]: handleGetCardActivities,
  [queryBuildCases.getCardMembers]: handleGetCardMembers,
  [queryBuildCases.getCardLabels]: handleGetCardLabels,
  [queryBuildCases.getCardAttachments]: handleGetCardAttachments,
  [queryBuildCases.getProjects]: handleGetProjects,
  [queryBuildCases.getProjects]: handleGetProjects,
  [queryBuildCases.getTrainerDropdown]: handleTrainerDropdown,
  [queryBuildCases.getCourseBundleTrainerDetails]: handleGetCourseBundleTrainerDetails,
  [queryBuildCases.getCourseBundleDetails]: handleGetCourseBundleDetails,
  [queryBuildCases.getAvailableResources]: handleGetAvailableResources,
  [queryBuildCases.getAvailableRooms]: handleGetAvailableRooms,
  [queryBuildCases.getCourseParticipantDetails]: handleGetCourseParticipantDetails,
  [queryBuildCases.getCourseDropdown]: handleGetCourseDropdown,
  [queryBuildCases.getAllCourseQuotes]: handleGetAllCourseQuotes,
  [queryBuildCases.getAllCoursePrivateCompanies]: handleGetAllCoursePrivateCompanies,
...
export async function handleAllInvoice(req: Request) {
  ...
  if (req?.query?.companies) {
    _.set(req.query, 'include[invoice_product]include[company][q][name][in]', (req?.query?.companies as string).split(','));
  }
...
export async function handleAllCourseCategory(req: Request) {
  ...
  if (req.query.member && req.query.isTrainer) {
    ...
    _.set(req?.query, 'include[courses]include[lessons][include][lesson_sessions][include][lessonSessionApproval]required', true);
  }
  if (req.query.status) {
    _.set(req?.query, 'include[courses]', 'all');
    _.set(req?.query, 'include[courses][q][is_template]', false);
...
export async function handleAllCalendarEvents(req: Request) {
  ...
  if (parse(req?.tokenData?.user)?.role_name === RoleEnum.Trainer) {
    ...
    //   userId,
    // );
    _.set(req?.query, 'include[course]include[lessons][include][lesson_sessions][include][lessonSessionApproval]required', true);
  }
  ...
  if (parse(req?.tokenData?.user)?.role_name === RoleEnum.PrivateIndividual) {
    ...
    _.set(req?.query, 'include[course][include][enrolled_courses][q][private_individual_id][eq]', req?.tokenData?.user?.id);
...
export async function handleCalendarEventDetail(req: Request) {
  ...
  _.set(req?.query, 'include[assignedTo][select]', 'id,full_name,first_name,last_name,email,contact,username,profile_image');
  _.set(req?.query, 'include[createdByUser][select]', 'id,full_name,first_name,last_name,email,contact,username,profile_image');
...
export async function handleRoomInfo(req: Request) {
  ...
  _.set(req?.query, 'include[creatorUser]', 'id,first_name,last_name,username,profile_image,verified,chat_user_status,full_name');
}
...
export async function handleUsersNotInCompanyProvided(req: Request) {
  ...
  _.set(
    req,
    'select',
    'id,email,full_name,first_name,last_name,username,contact,profile_image,address1,address2,city,state,country,zip,language,parent_table_id',
  );
  _.set(req?.query, 'include[managers][select]', 'id,user_id,job_title,language,parent_table_id');
...
export async function handleCourseFilter(req: Request) {
  ...
  if (parse(req?.tokenData?.user)?.role_name === RoleEnum.Trainer) {
    _.set(req?.query, 'include[lessons][include][lesson_sessions][include][lessonSessionApproval][select]', 'assigned_to_status');
    _.set(
      req?.query,
      'include[lessons][include][lesson_sessions][include][lessonSessionApproval][q][assigned_to_status]',
      AssignedStatus.Accepted,
    );
    _.set(req?.query, 'include[lessons][include][lesson_sessions][include][lessonSessionApproval][q][assigned_to]', userId);
...
export async function handleAllCourse(req: Request) {
  if (req?.query?.filterView) {
    ...
    if (req?.query?.tableView) await handleCourseV2(req);
      ...
      _.set(req?.query, 'include[lessonSessionApproval][include][assignedToUser]select', 'first_name,last_name,id,profile_image');
      _.set(req?.query, 'include[lessonSessionApproval][include][trainerAssignedRoomResources]', 'all');
      _.set(req?.query, 'include[lessonSessionApproval][include][trainerAssignedRoomResources][include][courseRoom]', 'all');
...
export async function handleAllCourseManager(req: Request) {
  ...
  if (!_.isUndefined(req.query.startDate) && !_.isUndefined(req.query.endDate)) {
    _.set(req?.query, 'q[start_date][between]', [new Date(String(req.query.startDate)), new Date(String(req.query.endDate))]);

    _.set(req?.query, 'q[end_date][between]', [new Date(String(req.query.startDate)), new Date(String(req.query.endDate))]);
  }
  ...
  if (!_.isUndefined(req.query.marked_as)) {
    ...
    if (markedAsValues.includes(CourseMarkAsEnum.SoldOut) || markedAsValues.includes(CourseMarkAsEnum.TemporarySoldOut)) {
  ...
  if (!_.isUndefined(req.query.detailedView)) {
    ...
    _.set(req?.query, 'include[lessons][include][lesson_sessions][select]', 'id,start_time,end_time,conference_provider');
    _.set(
      req?.query,
      'include[lessons][include][lesson_sessions][include][lessonSessionApproval][include][assignedToUser][select]',
      'first_name,last_name',
...
export async function handleAllCourseManagerEnrolledCourses(req: Request) {
  ...
  if (req.query?.course_type) {
    ...
    if (req.query?.course_type !== CourseType.Private) {
      ...
      _.set(req?.query, 'include[projects]include[card]include[card_Company][q][company_id][eq]', req?.query?.company_id);
      _.set(req?.query, 'include[projects][required]', true);
...
export async function handleCodeFilterReports(req: Request) {
  ...
  if (req?.query?.category_id) {
    ...
    _.set(req?.query, 'include[courses][include][courseCategory][q][id][in]', (req?.query?.category_id as string).split(','));
...
export async function handleCertificateRemain(req: Request) {
  ...
  _.set(req?.query, 'include[course_participates][include][courseParticipateExam][q][status]', ExamParticipateStatusEnum.pass);
...
export async function handlePendingProposals(req: Request) {
  ...
  _.set(req?.query, 'include[lessons][include][lesson_sessions][include][lessonSessionApproval][q][assigned_to_status][in]', [
...
export async function handleAllCourseManagerAttendees(req: Request) {
  ...
  _.set(req?.query, 'include[lesson_sessions]include[lesson_session_approval]include[courses][q][id][in]', req.query.courseIds);
}
...
export async function handleTrainerTodaySession(req: Request) {
  ...
  const currentDate = new Date(Date.UTC(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 0, 0, 0, 0));
  const endOfDay = new Date(Date.UTC(new Date().getFullYear(), new Date().getMonth(), new Date().getDate(), 23, 59, 59, 999));
...
export async function handleGetProjects(req: Request) {
  ...
  _.set(req?.query, 'include[courses][include][lessonSessionApproval][include][assignedToUser][include][trainer]', 'all');
...
export async function handleAllLessonApprovals(req: Request) {
  ...
  _.set(req?.query, 'include[assignedToUser][select]', 'id,full_name,first_name,last_name,email,contact,username,profile_image');
...
export async function handleGetCourseDetails(req: Request) {
  ...
  if (typeof req?.query?.checkCourseParticipatesCertiIssue === 'boolean') {
    _.set(req?.query, 'include[course_participates][q][is_certificate_issued]', req?.query?.checkCourseParticipatesCertiIssue);
  }
...
export async function handleGetRating(req: Request) {
  ...
  _.set(req.query, '[include][survey_question][q][question_type][in]', [SurveyQuestionEnum.rate, SurveyQuestionEnum.scale]);
...
export async function handleCourseBundle(req: Request) {
  ...
  _.set(req?.query, 'include[course_bundle]select', 'id,course_template_id,slug,course_bundle_id,created_by,updated_by,language');
...
export async function handleAllCompanyOfCourse(req: Request) {
  ...
  _.set(req?.query, 'include[course]include[lessonSessionApproval][include][assignedToUser]select', 'first_name,last_name,id');
...
export async function handleAllCourseUsedBundleData(req: Request) {
  ...
  if (req?.query?.editView) {
    ...
    _.set(req.query, 'include[lesson_session_approval]include[assignedToUser]', 'first_name,last_name,profile_image,id');
    _.set(
      req?.query,
...
export async function handleSurveyForm(req: Request) {
  ...
  if (req?.query?.sub_category_slug) {
    ...
    _.set(req.query, 'include[surveyTemplateQuestion]include[surveyAnswer]', 'id,slug,answer,language,survey_question_id');
    _.set(
      req.query,
...
export async function handleCourseBundleGetRoomAndResourcesAssignedToTrainers(req: Request) {
  ...
  _.set(req?.query, 'include[lesson_session_approval][include][trainerAssignedRoomResources][include][courseRoom]', 'all');
  _.set(req?.query, 'include[lesson_session_approval][include][trainerAssignedRoomResources][include][resource]', 'all');
  _.set(req?.query, 'include[trainer_assigned_room_resources]', 'all');
}
...
export function handleGetAvailableRooms(req: Request) {
  if (req?.query?.dates) {
    ...
    if (req?.query?.courseIds) _.set(req?.query, 'include[assigned_rooms]include[courses][q][id][notIn]', req?.query?.courseIds);
...
export function handleGetCourseParticipantDetails(req: Request) {
  ...
  _.set(req.query, 'include[course][include][lessons][include][lesson_sessions][include][courseAttendanceSheet]', 'all');
...
export function handleAllFilteredTrainers(req: Request) {
  ...
  if (req?.query?.categorySlug) {
    _.set(req?.query, 'include[trainer][include][trainerSubCategory][include][sub_category][q][slug]', req?.query?.categorySlug);
  }
  if (req?.query?.dates) {
    _.set(req?.query, 'include[assignedLessonSession][include][lessons][q][date][in]', (req?.query?.dates as String).split(','));
